...
Give `PLATFORM` variable to select platform (see Clash's release page: [https://github.com/Dreamacro/clash/releases](https://github.com/MetaCubeX/mihomo/releases))
